...
export const positionApi = {
  list: () => requestJson<Position[]>(API_URL),
  create: (payload: Partial<Position>) => requestJson<Position>(API_URL, {
    method: 'POST', body: JSON.stringify(payload),
  }),
  update: (id: string, payload: Partial<Position>) => requestJson<Position>(`${API_URL}/${id}`, {
