...
export const departmentApi = {
  list: () => requestJson<Department[]>(API_URL),
  create: (payload: Partial<Department>) => requestJson<Department>(API_URL, {
    method: 'POST', body: JSON.stringify(payload),
  }),
  update: (id: string, payload: Partial<Department>) => requestJson<Department>(`${API_URL}/${id}`, {
